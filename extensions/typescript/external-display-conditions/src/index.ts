...
// Declare global UIEditor interface
declare global {
    interface Window {
        UIEditor: {
...
function _runEditor(template: Template, extension: any): void {
    const container = document.querySelector<HTMLElement>('#stripoEditorContainer');
    if (!container) {
    ...
    window.UIEditor.initEditor(
        container,
        {
            ...
            locale: 'en',
            onTokenRefreshRequest: function (callback: (token: string) => void): void {
...
function _loadDemoTemplate(callback: (template: Template) => void): void {
    _request('GET', 'https://raw.githubusercontent.com/ardas/stripo-plugin/master/Public-Templates/Basic-Templates/Trigger%20newsletter%20mockup/Trigger%20newsletter%20mockup.html', null, function(html: string): void {
        _request('GET', 'https://raw.githubusercontent.com/ardas/stripo-plugin/master/Public-Templates/Basic-Templates/Trigger%20newsletter%20mockup/Trigger%20newsletter%20mockup.css', null, function(css: string): void {
