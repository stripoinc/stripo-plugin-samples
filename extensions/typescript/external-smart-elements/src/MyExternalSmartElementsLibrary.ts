...
export default class MyExternalSmartElementsLibrary extends ExternalSmartElementsLibrary {
     ...
     */
    openSmartElementsLibrary(onDataSelectCallback: (data: SmartElementCallbackData) => void, onCancelCallback: () => void): void {
        // Store callbacks
    ...
    private createModal(): void {
        ...
        this.externalLibrary = document.getElementById('externalSmartElementsLibrary') as HTMLElement;
    ...
    private onProductClick(e: Event): void {
        ...
        const productCard = (e.target as HTMLElement).closest('.product-card') as HTMLElement | null;
