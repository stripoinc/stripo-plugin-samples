...
export class CustomFontFamilySelectUIElement extends UIElement {
    ...
    private originalSelect!: HTMLElement & { value: string; setUIEAttribute: (name: string, value: any) => void };
    ...
    private _showDialog(): void {
        ...
        inputs.forEach(input => {
            input.addEventListener('input', () => {
                const errorMsg = this.dialog!.querySelector('#error-message') as HTMLElement;
                if (errorMsg) {
    ...
    private _submitDialog(): void {
        ...
        const fontFamilyInput = this.dialog!.querySelector('#fontFamily') as HTMLInputElement;
