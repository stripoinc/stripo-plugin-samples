...
export default class MyExternalImagesLibrary extends ExternalImageLibrary {
    ...
    private imageSelectCallback: (imageData: ImageCallbackData) => void = () => {};
     ...
     */
    openImageLibrary(currentImageUrl: string, onImageSelectCallback: (imageData: ImageCallbackData) => void, onCancelCallback: () => void): void {
        // Store callbacks
    ...
    private createModal(): void {
        ...
        this.externalLibrary = document.getElementById('externalImagesLibrary') as HTMLElement;
     ...
     */
    private generateImageThumbnails(): string {
    ...
    private onImageClick(e: Event): void {
        ...
        const imageData: ImageCallbackData = {
