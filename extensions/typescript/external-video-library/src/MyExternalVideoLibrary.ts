...
export default class MyExternalVideoLibrary extends ExternalVideosLibrary {
    ...
    private videoSelectCallback: (videoData: VideoCallbackData) => void = () => {};
     ...
     */
    openExternalVideosLibraryDialog(currentImageUrl: string, onVideoSelectCallback: (videoData: VideoCallbackData) => void, onCancelCallback: () => void): void {
        // Store callbacks
    ...
    private createModal(): void {
        ...
        this.externalLibrary = document.getElementById('externalVideoLibrary') as HTMLElement;
     ...
     */
    private generateVideoThumbnails(): string {
    ...
    private onVideoClick(e: Event): void {
        ...
        const videoData: VideoCallbackData = {
     ...
     */
    private filterVideos(category: string): void {
