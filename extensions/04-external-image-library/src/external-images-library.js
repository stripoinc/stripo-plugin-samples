/**
 * External Images Library Example
...
export default class ExternalImagesLibraryExample {
    ...
    generateModalHTML() {
        return `
            <div id="externalImagesLibrary" style="${this.styleObjToString(ExternalImagesLibraryExample.STYLES.overlay)}">
    ...
    generateHeaderHTML() {
        return `
            <div style="${this.styleObjToString(ExternalImagesLibraryExample.STYLES.header)}">
    ...
    generateFilterButtons() {
        ...
        return categories.map(cat => `
            <button 
                ...
                style="${this.styleObjToString(cat.active ? ExternalImagesLibraryExample.STYLES.buttonActive : ExternalImagesLibraryExample.STYLES.buttonInactive)}">
                ${cat.label}
            </button>
        `).join('');
    }
    ...
    generateImageThumbnails() {
        return ExternalImagesLibraryExample.IMAGES.map(image => `
            <div class="thumbnail" 
    ...
    updateActiveButton(activeButton) {
        ...
        buttons.forEach(button => {
            ...
            const styles = isActive ? 
                ExternalImagesLibraryExample.STYLES.buttonActive : 
                ExternalImagesLibraryExample.STYLES.buttonInactive;
    ...
    onImageClick(e) {
        ...
        // Сlose modal and execute callback
        this.close();
